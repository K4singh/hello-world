...
PIPELINE_ROOT = 'gs://tester-sandbox-movie-rating-bucket/pipeline_root'
PIPELINE_JOB_RUNNER_SERVICE_ACCOUNT = 'vertex-pipelines@tester-sandbox.iam.gserviceaccount.com'
